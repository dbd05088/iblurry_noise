...
def base_parser():
    ...
    parser.add_argument("--noisy_percent", type=int, help="noisy_ratio")
    parser.add_argument("--warm_up", type=int, default = 1, help="warm up")
    parser.add_argument("--robust_type", type=str, help="robust type")
    ...
    parser.add_argument("--coeff", type=float, default=0.5, help="learning rate")
    parser.add_argument("--rnd_seed", type=int, help="Random seed number.")
    parser.add_argument(
        "--memory_size", type=int, default=500, help="Episodic memory size"
    )
    parser.add_argument('--dataset_path', type=str, default="../dataset/cifar10/train")
    # Dataset
    parser.add_argument(
        "--log_path",
        type=str,
