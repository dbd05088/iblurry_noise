...
class ML(ER):
    ...
    def online_train(self, sample, batch_size, n_worker, iterations=1, stream_batch_size=0):
        #print("online_train iteration", iterations)
        total_loss, correct, num_data = 0.0, 0.0, 0.0
    ...
    def do_robust(self, iteration, n_worker, memory_batch_size):
        ...
        #print(mem_dataset)
        if self.robust_type == "DivideMix" and iteration>=self.warmup:
            print("div", iteration)
        ...
        elif self.robust_type == "PuriDivER" and iteration>=self.warmup:
