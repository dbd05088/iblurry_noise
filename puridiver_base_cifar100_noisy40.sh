...
# CIL CONFIG
NOTE="puridiver" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="puridiver"
...
NOISY_PERCENT=40
WARM_UP=5
ROBUST_TYPE="PuriDivER" # none, SELFIE, CoTeaching, DivideMix, PuriDivER
...
if [ "$DATASET" == "cifar10" ]; then
    ...
    BATCHSIZE=16; LR=0.05 OPT_NAME="sgd" SCHED_NAME="exp_reset" MEMORY_EPOCH=256
...
--rnd_seed $RND_SEED \
--warm_up $WARM_UP --dataset_path $DATAPATH \
